...
@Component({
    ...
    template: `
        <div class="field-wrap">
            <input #inputField class="{{inputClass}}" [ngClass]="{'inputInvalid' : !_valid}" type="text" placeholder="{{inputPlaceholder}}"
                   [(ngModel)]="currVal"
...
export class ComboBoxComponent implements ControlValueAccessor, OnInit {
    ...
    set currVal(value: string) {
        ...
        // if a validator function is prodided, use it to determine input validity.
        if (this.inputValidator !== undefined && this.inputValidator !== null) {
            this._valid = this.inputValidator(this.currVal);
        }
